 ...
 *
 */
public class IngresarUsuario extends JPanel {
    ...
    private void initComponents() {
        ...
        idUsuarioField.addKeyListener(formListener);
        ...
        tipoField.addKeyListener(formListener);
        ...
        combo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "ADMINISTRADOR", "USUARIO", "CAJERO" }));
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(idUsuarioField, javax.swing.GroupLayout.DEFAULT_SIZE, 314, Short.MAX_VALUE)
                                    .addComponent(nombreField, javax.swing.GroupLayout.DEFAULT_SIZE, 314, Short.MAX_VALUE)
                                    .addComponent(contraseñaField, javax.swing.GroupLayout.DEFAULT_SIZE, 314, Short.MAX_VALUE)
                                    .addGroup(layout.createSequentialGroup()
                                        .addComponent(combo, javax.swing.GroupLayout.PREFERRED_SIZE, 128, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(tipoField, javax.swing.GroupLayout.DEFAULT_SIZE, 180, Short.MAX_VALUE))))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(tipoLabel)
                    .addComponent(tipoField, javax.swing.GroupLayout.PREFERRED_SIZE, 0, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private class FormListener implements java.awt.event.ActionListener, java.awt.event.KeyListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                IngresarUsuario.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                IngresarUsuario.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton) {
                IngresarUsuario.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                IngresarUsuario.this.deleteButtonActionPerformed(evt);
            }
        }
        ...
        public void keyTyped(java.awt.event.KeyEvent evt) {
            if (evt.getSource() == idUsuarioField) {
                IngresarUsuario.this.idUsuarioFieldKeyTyped(evt);
            }
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<clasesbasicas.Usuario_1> toRemove = new ArrayList<clasesbasicas.Usuario_1>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            clasesbasicas.Usuario_1 u = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(u);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        ...
        clasesbasicas.Usuario_1 u = new clasesbasicas.Usuario_1();
...
tipoField.setText(COMBO);
        ...
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<clasesbasicas.Usuario_1> merged = new ArrayList<clasesbasicas.Usuario_1>(list.size());
            for (clasesbasicas.Usuario_1 u : list) {
    ...
    private void idUsuarioFieldKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_idUsuarioFieldKeyTyped
       
    }//GEN-LAST:event_idUsuarioFieldKeyTyped
    ...
    private java.util.List<clasesbasicas.Usuario_1> list;
